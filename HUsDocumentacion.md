# Historias de Usuario — Sistema Fiestas del Señor de Burgos

## AUTH-01 — Registro de usuario con correo y contraseña

| Identificador de la historia | AUTH-01 | Nombre de la historia | Registro de usuario con correo y contraseña |
|---|---|---|---|

**Historia de Usuario**

Como visitante, quiero registrarme ingresando un nombre de usuario, correo electrónico y contraseña, para poder participar en el concurso y en la dinámica de la fiesta.
...
- El sistema debe rechazar el registro si falta el nombre de usuario, el correo o la contraseña, mostrando "Debe completar todos los campos obligatorios".
- El sistema debe validar que el correo tenga un formato válido antes de aceptar el registro.
- El sistema debe exigir una longitud mínima de contraseña (por ejemplo, 8 caracteres), rechazando contraseñas más cortas con el mensaje "La contraseña debe tener al menos 8 caracteres".
- La contraseña debe almacenarse siempre cifrada (hash), nunca en texto plano.
- Todo usuario registrado por este medio debe quedar con el rol "participante" de forma predeterminada.
...
## AUTH-02 — Inicio de sesión con correo y contraseña

| Identificador de la historia | AUTH-02 | Nombre de la historia | Inicio de sesión con correo y contraseña |
|---|---|---|---|

**Historia de Usuario**

Como usuario registrado, quiero iniciar sesión con mi correo y contraseña, para acceder a las funciones del sistema según mi rol.
...
**Criterio de aceptación**
- Si el correo no está registrado o la contraseña no coincide, el sistema debe mostrar el mismo mensaje genérico "Correo o contraseña incorrectos", sin indicar cuál de los dos falló.
- Al iniciar sesión correctamente, el sistema debe identificar el rol del usuario (administrador o participante) para habilitar las acciones correspondientes.
- El sistema debe bloquear temporalmente los intentos de inicio de sesión tras varios intentos fallidos consecutivos (por ejemplo, 5), para prevenir ataques de fuerza bruta.
...
## AUTH-03 — Registro e inicio de sesión con autenticación de Google

| Identificador de la historia | AUTH-03 | Nombre de la historia | Registro e inicio de sesión con autenticación de Google |
|---|---|---|---|

**Historia de Usuario**

Como visitante, quiero registrarme o iniciar sesión usando mi cuenta de Google, para acceder al sistema sin tener que crear una contraseña nueva.

**Flujo de autenticación**
- Botón "Continuar con Google"
- Verificación del correo devuelto por Google contra los correos ya registrados

**Criterio de aceptación**
- El sistema debe redirigir al flujo de autenticación de Google y, al recibir una respuesta válida, verificar si el correo asociado ya existe en el sistema.
- Si el correo no existe aún, el sistema debe crear automáticamente un nuevo usuario con ese correo y el rol "participante", sin solicitar contraseña.
- Si el correo ya existe (por ejemplo, porque el usuario ya se había registrado con correo y contraseña), el sistema debe iniciar sesión en esa cuenta existente en lugar de crear una duplicada.
- Si la autenticación con Google falla o es cancelada por el usuario, el sistema debe mostrar "No se pudo completar la autenticación con Google" y permitir reintentar.
...
## AUTH-04 — Validación de correo único en el registro

| Identificador de la historia | AUTH-04 | Nombre de la historia | Validación de correo único en el registro |
|---|---|---|---|

**Historia de Usuario**

Como sistema, debo impedir que dos cuentas se registren con el mismo correo electrónico, para evitar identidades duplicadas.

**Comportamiento y validaciones**
- Verificación de unicidad de correo antes de crear cualquier cuenta nueva

**Criterio de aceptación**
- Si un usuario intenta registrarse con correo y contraseña usando un correo ya existente, el sistema debe rechazar el registro mostrando "Este correo ya está registrado. Intenta iniciar sesión".
- La validación de unicidad debe aplicarse sin importar si la cuenta existente se creó por correo/contraseña o por Google, ya que ambos caminos deben converger en el mismo usuario.
